...
function createUncontrolledClassComponent(Comp, methods) {
    ...
    var Component = function (props) { return (react_1["default"].createElement(Comp, tslib_1.__assign({}, (props !== null && props !== void 0 ? props : {}), { ref: handleRef }))); };
    var final = Object.fromEntries(Object.entries(methods).map(function (method) {
        ...
        var newFunc = function () {
            ...
            return func.apply(void 0, tslib_1.__spreadArray([instance], args, false));
        };
        return [k, newFunc];
    }));
    return tslib_1.__assign({ Component: Component, isInstanceMounted: isInstanceMounted }, final);
}
