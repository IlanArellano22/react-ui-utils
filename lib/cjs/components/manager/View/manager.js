...
var ViewManagerComponent = /** @class */ (function (_super) {
    tslib_1.__extends(ViewManagerComponent, _super);
    function ViewManagerComponent(props) {
        ...
        _this.show = function (render, props, context) {
            return new Promise(function (resolve) {
                ...
                var entry = {
                    id: currId,
                    render: render,
                    props: tslib_1.__assign({ onClose: _this.handleClose(currId, resolve) }, (props || {}))
                };
        ...
        _this.showSync = function (render, props, context) {
            ...
            var entry = {
                id: currId,
                render: render,
                props: tslib_1.__assign(tslib_1.__assign({}, (props || {})), { onClose: function (res) {
                        result = res;
                    } })
            };
            return {
    ...
    ViewManagerComponent.prototype.render = function () {
        if (this.props.context)
            return (react_1["default"].createElement(react_1["default"].Fragment, null,
                ...
                react_1["default"].createElement(comp_1.ViewMainComponent, tslib_1.__assign({}, this.state))));
        return react_1["default"].createElement(comp_1.ViewMainComponent, tslib_1.__assign({}, this.state));
    };
